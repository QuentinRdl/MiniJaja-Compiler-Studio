...
public class HeapElementTest {
    ...
    void TryMergeAllocatedNeighbor(){
        HeapElement e = new HeapElement(0, 50, 10);
        HeapElement f = e.split(6);
    ...
    void TryMergeMultipleWithAllocation(){
        HeapElement e = new HeapElement(0, 50, 100);
        e.split(40);
        var f = e.split(20);
        e.split(30,true);
